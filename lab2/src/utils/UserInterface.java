...
import namedEntities.heuristics.Getter;
...
public class UserInterface {
  ...
  public Config handleInput(String[] args) {
    ...
    return new Config(printHelp, processFeed, feedKey, computeNamedEntities, heuristic, printFeed, statsFormat, format);
  }

  // funciones para ver si los argumentos de los flags son validos

  public static boolean validFeedKey(String feedKey, List<FeedsData> feedsDataArray) {
    boolean valid = false;
    for (FeedsData feedData : feedsDataArray) {
      valid |= feedKey.equals(feedData.getLabel());
    }
    return valid;
  }
